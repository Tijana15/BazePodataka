...
INSERT INTO drogerija.ZAPOSLENI (Ime, Prezime, Telefon, Adresa, Smjena, Zaduženje, Plata, DatumZaposlenja) VALUES
('Jovan', 'Jovanović', '+381641234567', 'Knez Mihailova 5, Beograd', 'Prva smjena', 'Prodaja kozmetike', 45000.00, '2023-02-15'),
('Milica', 'Petrović', '+381611234567', 'Njegoševa 10, Novi Sad', 'Druga smjena', 'Nabavka robe', 50000.00, '2022-09-20'),
('Stefan', 'Đorđević', '+381641234567', 'Cara Dušana 15, Niš', 'Treća smjena', 'Računovodstvo', 55000.00, '2023-01-10'),
('Ana', 'Marković', '+381621234567', 'Kralja Petra 8, Subotica', 'Prva smjena', 'Prodaja parfema', 48000.00, '2023-03-05'),
('Nikola', 'Nikolić', '+381631234567', 'Trg Republike 3, Kragujevac', 'Druga smjena', 'Marketing', 52000.00, '2022-12-12'),
('Jovana', 'Stojanović', '+381641234567', 'Vuka Karadžića 12, Čačak', 'Prva smjena', 'Administracija', 46000.00, '2023-04-18'),
('Filip', 'Ilić', '+381611234567', 'Gospodar Jevremova 20, Zrenjanin', 'Treća smjena', 'IT podrška', 58000.00, '2022-11-25'),
('Mila', 'Pavlović', '+381621234567', 'Nikole Pašića 25, Novi Pazar', 'Prva smjena', 'Prodaja makeupa', 49000.00, '2023-02-28'),
('Marko', 'Stanković', '+381631234567', 'Svetog Save 7, Šabac', 'Druga smjena', 'Logistika', 51000.00, '2022-10-08'),
('Jelena', 'Simić', '+381641234567', 'Karađorđeva 30, Kraljevo', 'Treća smjena', 'Prodaja lijekova', 56000.00, '2023-01-15');
...
INSERT INTO drogerija.RADNIK (JeŠefSmjene, ZAPOSLENI_IdZaposlenog, ODJEL_IdOdjela) VALUES
(1, 1, 1),
(0, 2, 2),
(0, 3, 3),
(0, 4, 4),
...
-- Kreiranje naloga za zaposlene na osnovu njihovih podataka
INSERT INTO drogerija.NALOG (KorisnickoIme, Lozinka, IdNaloga, RADNIK_IdRadnika)
VALUES
('jovan.jovanovic', 'jovan123', 1, 1),          -- Korisnik: jovan.jovanovic, Lozinka: jovan123, Id naloga: 1, Radnik ID: 1 (Jovan Jovanović)
('milica.petrovic', 'milica123', 2, 2),        -- Korisnik: milica.petrovic, Lozinka: milica123, Id naloga: 2, Radnik ID: 2 (Milica Petrović)
('stefan.djordjevic', 'stefan123', 3, 3),      -- Korisnik: stefan.djordjevic, Lozinka: stefan123, Id naloga: 3, Radnik ID: 3 (Stefan Đorđević)
('ana.markovic', 'ana123', 4, 4),              -- Korisnik: ana.markovic, Lozinka: ana123, Id naloga: 4, Radnik ID: 4 (Ana Marković)
('nikola.nikolic', 'nikola123', 5, 5),         -- Korisnik: nikola.nikolic, Lozinka: nikola123, Id naloga: 5, Radnik ID: 5 (Nikola Nikolić)
('jovana.stojanovic', 'jovana123', 6, 6),      -- Korisnik: jovana.stojanovic, Lozinka: jovana123, Id naloga: 6, Radnik ID: 6 (Jovana Stojanović)
('filip.ilic', 'filip123', 7, 7),              -- Korisnik: filip.ilic, Lozinka: filip123, Id naloga: 7, Radnik ID: 7 (Filip Ilić)
('mila.pavlovic', 'mila123', 8, 8),            -- Korisnik: mila.pavlovic, Lozinka: mila123, Id naloga: 8, Radnik ID: 8 (Mila Pavlović)
('marko.stankovic', 'marko123', 9, 9),         -- Korisnik: marko.stankovic, Lozinka: marko123, Id naloga: 9, Radnik ID: 9 (Marko Stanković)
('jelena.simic', 'jelena123', 10, 10);         -- Korisnik: jelena.simic, Lozinka: jelena123, Id naloga: 10, Radnik ID: 10 (Jelena Simić)
