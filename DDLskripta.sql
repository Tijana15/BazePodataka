...
CREATE TABLE IF NOT EXISTS `drogerija`.`STAVKA_NABAVKE` (
  `NABAVKA_IdNabavke` INT NOT NULL,
  `CijenaNabavna` DECIMAL(10,2) NOT NULL,
  `NABAVLJANJE_IdNabavke` INT NOT NULL,
  `Kolicina` INT NOT NULL,
  PRIMARY KEY (`NABAVKA_IdNabavke`, `NABAVLJANJE_IdNabavke`),
...
CREATE TABLE IF NOT EXISTS `drogerija`.`PRODAJNI_ARTIKL` (
  ...
  `PROIZVOD_IdProizvod` INT NOT NULL,
  `STAVKA_NABAVKE_NABAVKA_IdNabavke` INT NOT NULL,
  `STAVKA_NABAVKE_NABAVLJANJE_IdNabavke` INT NOT NULL,
  INDEX `fk_PRODAJNI_ARTIKL_PROIZVOD1_idx` (`PROIZVOD_IdProizvod` ASC) VISIBLE,
  PRIMARY KEY (`PROIZVOD_IdProizvod`, `STAVKA_NABAVKE_NABAVKA_IdNabavke`, `STAVKA_NABAVKE_NABAVLJANJE_IdNabavke`),
  INDEX `fk_PRODAJNI_ARTIKL_STAVKA_NABAVKE1_idx` (`STAVKA_NABAVKE_NABAVKA_IdNabavke` ASC, `STAVKA_NABAVKE_NABAVLJANJE_IdNabavke` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_PRODAJNI_ARTIKL_STAVKA_NABAVKE1`
    FOREIGN KEY (`STAVKA_NABAVKE_NABAVKA_IdNabavke` , `STAVKA_NABAVKE_NABAVLJANJE_IdNabavke`)
    REFERENCES `drogerija`.`STAVKA_NABAVKE` (`NABAVKA_IdNabavke` , `NABAVLJANJE_IdNabavke`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `drogerija`.`RADNIK` (
  ...
  `ZAPOSLENI_IdZaposlenog` INT NOT NULL,
  `IdRadnika` INT NOT NULL AUTO_INCREMENT,
  `ODJEL_IdOdjela` INT NOT NULL,
  ...
  UNIQUE INDEX `IdRadnika_UNIQUE` (`IdRadnika` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `drogerija`.`NALOG` (
  ...
  `RADNIK_IdRadnika` INT NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`IdNaloga`),
  INDEX `fk_NALOG_RADNIK1_idx` (`RADNIK_IdRadnika` ASC) VISIBLE,
  CONSTRAINT `fk_NALOG_RADNIK1`
    FOREIGN KEY (`RADNIK_IdRadnika`)
    REFERENCES `drogerija`.`RADNIK` (`IdRadnika`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `drogerija`.`KASA_KORISTENJE` (
  ...
  PRIMARY KEY (`IdKoristenjaKase`, `NALOG_IdNaloga`, `KASA_IdKasa`),
